	...
	ResponseEntity<SuccessResponse<Void>> create(
		...
		@io.swagger.v3.oas.annotations.parameters.RequestBody(required = true,
			content = @Content(schema = @Schema(implementation = CreateTimelineRequest.class),
				examples = @ExampleObject(value = "{\"title\":\"정상 도착\",\"timelineImageObjectKey\":\"550e8400-summit.jpg\",\"createdAt\":\"2026-07-02T10:45:00\",\"trackPointIndex\":35,\"location\":{\"longitude\":127.123456,\"latitude\":37.123456,\"elevation\":542.3,\"pointIndex\":35},\"status\":\"SUCCESSFUL_CREATED\"}")))
